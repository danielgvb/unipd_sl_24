...
```{r,echo=FALSE,fig.width=6.2, fig.height=3}
{par(mfrow = c(1, 2))
...
# Plot residuals vs fitted values
plot(model_lag, which = 1, main = "Residuals vs Fitted",cex.main=0.8)

# Plot QQ plot
plot(model_lag, which = 2, main = "Normal Q-Q",cex.main=0.8)
}
...
# Plot residuals vs fitted values
plot(forward_model, which = 1, main = "Residuals vs Fitted",cex.main=0.8)

# Plot QQ plot
plot(forward_model, which = 2, main = "Normal Q-Q",cex.main=0.8)
}
...
# Plot residuals vs fitted values
plot(backward_model, which = 1, main = "Residuals vs Fitted",cex.main=0.8)

# Plot QQ plot
plot(backward_model, which = 2, main = "Normal Q-Q",cex.main=0.8)
}
...
Cámara Colombiana de Contrucción: https://camacol.co/informacion-economica
