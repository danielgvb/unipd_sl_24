...
As part of the exploratory analysis we study the percentual variation of the variables. This with the intention to identify trends and patterns in a clearly way.
...
Another useful information can be find in the box plots and histograms for the percentual variations,in these plots we see that the central value of the percentual variations is positive, indicating and overall increase. the outliers were expected in the sense of those negatives variations due to the decrease on the last years of the House Price Index. Also, it is possible to see this on the histogram a right skewed behavior.
