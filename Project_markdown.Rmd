...
| Variable                      | Values                                                                                                     |
|-------------------------------|------------------------------------------------------------------------------------------------------------|
| Home_Price_Index              | numeric(0)                                                                                                |
| Industrial_Inputs_Index       | numeric(0)                                                                                                |
| Metals_Price_Index            | numeric(0)                                                                                                |
...
| Google_Trends_Housing         | numeric(0)         
